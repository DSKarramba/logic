...
function sram4bit(/* arrays */ el, wire, inputs) {    
    ...
    el.push(new TEXT(5, 370, 'data IN'));
    ...
    el.push(new TEXT(5, 420, 'C'));
    el.push(new INPUT(node[71], inputs[4])); // R/nW
    el.push(new TEXT(5, 470, 'R/nW'));
    ...
    el.push(new TEXT(370, 520, 'data OUT'));
