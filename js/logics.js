...
var And, BTRI, DEBUG, Input, JK, NULL, Node, Not, ONE, Or, Output, RS, Wire, Z, clear, connected_nodes, ctx, dark, draw_text, elem, i, inp, input, logics, node, nodes, out, output, state_from_value, wire, wires, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _len7, _m, _n, _o, _p, _q, _ref, _ref1;
...
logics = [new Not(ctx, nodes[1], nodes[2]), new Or(ctx, nodes[3], nodes[5], nodes[6])];
